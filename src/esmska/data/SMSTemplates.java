...
public class SMSTemplates {
    ...
    private static final SMSTemplates instance = new SMSTemplates();
    private final List<SMSTemplate> templates = Collections.synchronizedList(new ArrayList<SMSTemplate>());
    private static final Logger logger = Logger.getLogger(SMSTemplates.class.getName());
    ...
    /** Get shared instance */
    public static SMSTemplates getInstance() {
        return instance;
    }
    /** get all template */
